...
async function requestData(url, method, params = {}) {
  ...
  myHeaders.append("Content-Type", "application/json");
  myHeaders.append("Access-Control-Allow-Origin", "http://13.127.101.102:5011");
...
async function fileUplodeDynamic(
  ...
  let bash_url = "http://13.127.101.102:5011/api/user/";
  let apiUrl = bash_url + url;
  ...
  let headers = {
    ...
    "Access-Control-Allow-Origin": "http://13.127.101.102:5011",
